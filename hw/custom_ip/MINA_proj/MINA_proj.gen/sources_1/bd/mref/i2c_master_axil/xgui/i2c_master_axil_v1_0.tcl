...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "READ_FIFO_DEPTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "WRITE_FIFO" -parent ${Page_0}
  ipgui::add_param $IPINST -name "WRITE_FIFO_DEPTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.READ_FIFO_DEPTH { PARAM_VALUE.READ_FIFO_DEPTH } {
	# Procedure called to update READ_FIFO_DEPTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.READ_FIFO_DEPTH { PARAM_VALUE.READ_FIFO_DEPTH } {
	# Procedure called to validate READ_FIFO_DEPTH
	return true
}
...
proc update_PARAM_VALUE.WRITE_FIFO_DEPTH { PARAM_VALUE.WRITE_FIFO_DEPTH } {
	# Procedure called to update WRITE_FIFO_DEPTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.WRITE_FIFO_DEPTH { PARAM_VALUE.WRITE_FIFO_DEPTH } {
	# Procedure called to validate WRITE_FIFO_DEPTH
	return true
}
...
proc update_MODELPARAM_VALUE.WRITE_FIFO_DEPTH { MODELPARAM_VALUE.WRITE_FIFO_DEPTH PARAM_VALUE.WRITE_FIFO_DEPTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.WRITE_FIFO_DEPTH}] ${MODELPARAM_VALUE.WRITE_FIFO_DEPTH}
}
...
proc update_MODELPARAM_VALUE.READ_FIFO_DEPTH { MODELPARAM_VALUE.READ_FIFO_DEPTH PARAM_VALUE.READ_FIFO_DEPTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.READ_FIFO_DEPTH}] ${MODELPARAM_VALUE.READ_FIFO_DEPTH}
}
