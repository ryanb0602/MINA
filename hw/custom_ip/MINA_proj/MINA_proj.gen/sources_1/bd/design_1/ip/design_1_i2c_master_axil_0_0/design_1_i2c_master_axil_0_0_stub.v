...
//               /home/ryanb/Documents/MINA/hw/custom_ip/MINA_proj/MINA_proj.gen/sources_1/bd/design_1/ip/design_1_i2c_master_axil_0_0/design_1_i2c_master_axil_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_i2c_master_axil_0_0,i2c_master_axil,{}" *) (* CORE_GENERATION_INFO = "design_1_i2c_master_axil_0_0,i2c_master_axil,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=i2c_master_axil,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,DEFAULT_PRESCALE=1,FIXED_PRESCALE=0,CMD_FIFO=1,CMD_FIFO_DEPTH=32,WRITE_FIFO=1,WRITE_FIFO_DEPTH=32,READ_FIFO=1,READ_FIFO_DEPTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "i2c_master_axil,Vivado 2025.2" *) 
module design_1_i2c_master_axil_0_0(clk, rst, s_axil_awaddr, s_axil_awprot, 
  ...
  s_axil_arready, s_axil_rdata, s_axil_rresp, s_axil_rvalid, s_axil_rready, i2c_scl_i, 
  i2c_scl_o, i2c_scl_t, i2c_sda_i, i2c_sda_o, i2c_sda_t)
/* synthesis syn_black_box black_box_pad_pin="rst,s_axil_awaddr[3:0],s_axil_awprot[2:0],s_axil_awvalid,s_axil_awready,s_axil_wdata[31:0],s_axil_wstrb[3:0],s_axil_wvalid,s_axil_wready,s_axil_bresp[1:0],s_axil_bvalid,s_axil_bready,s_axil_araddr[3:0],s_axil_arprot[2:0],s_axil_arvalid,s_axil_arready,s_axil_rdata[31:0],s_axil_rresp[1:0],s_axil_rvalid,s_axil_rready,i2c_scl_i,i2c_scl_o,i2c_scl_t,i2c_sda_i,i2c_sda_o,i2c_sda_t" */
/* synthesis syn_force_seq_prim="clk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 clk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME clk, ASSOCIATED_BUSIF s_axil, ASSOCIATED_RESET rst, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0" *) input clk /* synthesis syn_isclock = 1 */;
