...
simulate()
{
  xsim design_1 -key {Behavioral:bootloader_tb:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/bd_88fd.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
