...
HD_PWD='/home/ryanb/Documents/MINA/hw/custom_ip/MINA_proj/MINA_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VexRiscvMcuAxi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VexRiscvMcuAxi.tcl
