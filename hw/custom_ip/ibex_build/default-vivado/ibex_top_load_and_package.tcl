...
# --- IP Packaging Section ---

# 1. Define where the packaged IP will be saved (creates a folder in your build dir)
set ip_dir "./packaged_ip"

# 2. Package the current project into that directory
ipx::package_project -root_dir $ip_dir -vendor lowrisc.org -library user -taxonomy /UserIP -import_files

# 3. Get a handle to the newly created IP core object
set core [ipx::current_core]

# 4. Set basic IP properties
set_property name "ibex_top" $core
set_property version "0.1" $core
set_property display_name "Ibex RISC-V Core (MaxPerf)" $core
set_property description "Parameterized Ibex Core generated via FuseSoC" $core

# 5. Generate the GUI files, update checksums, and save
ipx::create_xgui_files $core
ipx::update_checksums $core
ipx::save_core $core

# 6. Close the project cleanly
close_project
